...
var map = new mapboxgl.Map({
    container: 'map',
    style:  'style.json',//'mapbox://styles/mapbox/satellite-v9',//'style.json',
    center: [-4.1089, 39.9519],
    zoom: 7
});
...
map.on('load',function() {
    ...
    map.addSource('test', {
        'type': 'raster',
        'tiles': ["http://www.higis.org.cn:55559/OBO/lsproads/1000//{z}/{x}/{y}.png"],
        //'tileSize':256,
        'minzoom': 0,
        'maxzoom': 24
    });
    ...
    Enter.addEventListener('click', function () {
        ...
        var radius = parseInt(numEl.value);
        ...
        map.addSource(id, {   
            'type': 'raster',
            'tiles': [`http://www.higis.org.cn:55559/OBO/${layer_value}/${radius}//{z}/{x}/{y}.png`],
          //  'tileSize':256,
            'minzoom': 0,
            'maxzoom': 24
        });
